...
# Creating the Email introduction class
...
# creating a ranked article detailed class
...
# creating digest response for email class
...
# creating a class for email digest
