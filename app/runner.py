...
from app.scrapers.anthropic import AnthropicScraper, AnthropicArticles
from app.database.repository import Repository


# defining function to run the three scrapers
def run_scrapers(hours: int = 24) -> dict:
    ...
    for channel_id in YOUTUBE_CHANNELS:
        videos = youtube_scraper.get_latest_videos(channel_id=channel_id, hours=hours)
